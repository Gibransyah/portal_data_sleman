export const metadata = {
  title: "Tentang | Data Sleman",
  description:
    "Informasi tentang portal data dan dashboard Kabupaten Sleman: tujuan, prinsip, sumber data, dan kontak.",
};

export default function TentangPage() {
  return (
    <main className="min-h-screen bg-blue-50 dark:bg-blue-950 text-blue-950 dark:text-blue-50">
      {/* Hero */}
      <section className="pt-28 pb-14 px-6 bg-gradient-to-b from-blue-700 to-blue-600 dark:from-blue-900 dark:to-blue-800 text-white">
      ...
      <section className="px-6 py-12">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-10">
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-6 md:p-8 border border-blue-200 dark:border-blue-800">
              ...
              <ul className="list-disc pl-6 mt-4 space-y-2 text-blue-800/80 dark:text-blue-200">
            ...
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-6 md:p-8 border border-blue-200 dark:border-blue-800">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800">
                  <h3 className="font-semibold">Keterbukaan & Transparansi</h3>
                  <p className="text-sm mt-1 text-blue-700/80 dark:text-blue-200">
            ...
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-6 md:p-8 border border-blue-200 dark:border-blue-800">
              ...
              <p className="text-sm text-blue-700/70 dark:text-blue-300 mt-4">
            ...
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-6 md:p-8 border border-blue-200 dark:border-blue-800">
              ...
              <ul className="grid sm:grid-cols-2 gap-3">
                <li className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800">
                  <span className="font-semibold">Pencarian cerdas</span>
                  <p className="text-sm text-blue-700/80 dark:text-blue-200 mt-1">Cari dataset dan dashboard berdasarkan kata kunci/topik.</p>
                </li>
                <li className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800">
                  <span className="font-semibold">Ringkasan visual</span>
                  <p className="text-sm text-blue-700/80 dark:text-blue-200 mt-1">Visualisasi yang memudahkan pemahaman cepat.</p>
                </li>
                <li className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800">
                  <span className="font-semibold">Detail dataset</span>
                  <p className="text-sm text-blue-700/80 dark:text-blue-200 mt-1">Akses ke portal asal dan tautan unduhan bila tersedia.</p>
                </li>
                <li className="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800">
                  <span className="font-semibold">Topik & kategori</span>
                  <p className="text-sm text-blue-700/80 dark:text-blue-200 mt-1">Jelajahi berdasarkan topik seperti kesehatan, pendidikan, dan lainnya.</p>
                </li>
              </ul>
            </div>
          </div>
          ...
          <aside className="space-y-6">
            <div className="bg-white dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-800">
